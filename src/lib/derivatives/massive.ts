 ...
 * You may need to adjust these paths to your vendor.
 */
 ...
 * Vendor-specific: adjust path + response shape if needed.
 */
 ...
 * Polygon-style snapshot endpoints don’t always accept expiration as a filter;
 * many require pulling snapshot then filtering client-side.
 */
